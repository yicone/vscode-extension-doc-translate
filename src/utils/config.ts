...
export class ConfigManager {
    ...
    static getProvider(): LLMProvider {
        return this.getConfig().get<LLMProvider>('provider') || DEFAULT_CONFIG.PROVIDER;
    }
    ...
    static getTargetLang(): string {
        return this.getConfig().get<string>('targetLang') || DEFAULT_CONFIG.TARGET_LANG;
    }
    ...
    static getAnthropicModel(): string {
        return this.getConfig().get<string>('model') || DEFAULT_CONFIG.ANTHROPIC_MODEL;
    }
    ...
    static getOpenAIModel(): string {
        return this.getConfig().get<string>('openaiModel') || DEFAULT_CONFIG.OPENAI_MODEL;
    }
    ...
    static getGeminiModel(): string {
        return this.getConfig().get<string>('geminiModel') || DEFAULT_CONFIG.GEMINI_MODEL;
    }
    ...
    static getRetryConfig(): RetryConfig {
        return {
            maxRetries: this.getConfig().get<number>('maxRetries') || DEFAULT_RETRY_CONFIG.maxRetries,
            initialDelayMs: this.getConfig().get<number>('retryInitialDelay') || DEFAULT_RETRY_CONFIG.initialDelayMs,
    ...
    static getSupportedLanguages(): string[] {
        return this.getConfig().get<string[]>('supportedLanguages') || ['python', 'javascript', 'typescript', 'go'];
    }
}
